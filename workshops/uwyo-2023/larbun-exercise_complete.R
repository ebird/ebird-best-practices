...
# abundance hurdle model for Lark Bunting in Wyoming in June-July using eBird
# data from 2014-2023.
...
# checklist data
f_sed <- "data-raw/ebd_US-WY_larbun_smp_relOct-2023_sampling.txt"
checklists <- read_sampling(f_sed)
# observation data
f_ebd <- "data-raw/ebd_US-WY_larbun_smp_relOct-2023.txt"
...
checklists <- checklists |>
  filter(all_species_reported,
         ...
         between(month(observation_date), 6, 7))
...
write_csv(checklists, "data/checklists-zf_larbun_jun-jul_us-wy.csv", na = "")
