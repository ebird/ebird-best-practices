...
# range boundary
png("workshops/woothr_range.png", width = 400, height = 400)
...
# encounter rate
png("workshops/woothr_encounter-rate.png", width = 400, height = 400)
...
predictions$abundance <- predictions$in_range * predictions$encounter_rate * predictions$count
...
png("workshops/woothr_relative-abundance.png", width = 400, height = 400)
par(mar = c(4, 0.25, 0.25, 0.25))
# set up plot area
plot(study_region, col = NA, border = NA)
plot(ne_land, col = "#cfcfcf", border = "#888888", lwd = 0.5, add = TRUE)
