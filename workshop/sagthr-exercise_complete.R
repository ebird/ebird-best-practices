...
# checklist data
f_sed <- "data-raw/ebd_US-WY_sagthr_smp_relOct-2023_sampling.txt"
checklists <- read_sampling(f_sed)
# observation data
f_ebd <- "data-raw/ebd_US-WY_sagthr_smp_relOct-2023.txt"
...
write_csv(checklists, "data/checklists-zf_sagthr_jun-jul_us-wy.csv", na = "")
