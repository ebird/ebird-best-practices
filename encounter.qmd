...
Both elevation variables have high importance, and the top habitat variables are from landcover classes 14, 21, and 22. To lookup the descriptions of each of these classes refer to file `data/mcd12q1_fao_classes.csv` in the [data package](#intro-setup-data) for this book.
