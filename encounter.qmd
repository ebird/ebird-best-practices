...
The subsampling *decreased* the overall number of checklists by a factor of about `r round(nrow(checklists) / nrow(checklists_ss), 1)`, but *increased* the prevalence of detections from `r pct_before` to `r pct_after`. 
