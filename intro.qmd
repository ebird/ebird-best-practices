...
Once you become familiar with the pipe operator, we believe you'll find the above example using the pipe the easiest of the three to read and interpret.
...
ne_state_lines <- ne_download(scale = 50, category = "cultural",
  ...
  mutate(iso_a2 = recode(ADM0_A3, USA = "US", CAN = "CA")) |> 
